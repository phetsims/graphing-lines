...
/**
 * Manipulator for changing a line's point (x1,y1).
 *
...
define( function( require ) {
  ...
  function X1Y1DragHandler( lineProperty, x1RangeProperty, y1RangeProperty, mvt, constantSlope ) {
    ...
    SimpleDragHandler.call( this, {
      ...
      start: function( event ) {
        var location = mvt.modelToViewPosition( new Vector2( lineProperty.get().x1, lineProperty.get().y1 ) );
  ...
  function X1Y1Manipulator( diameter, interactiveLineProperty, x1RangeProperty, y1RangeProperty, mvt, constantSlope ) {
    ...
    var thisNode = this;
    LineManipulator.call( thisNode, diameter, GLColors.POINT_X1_Y1 );
  ...
  return inherit( LineManipulator, X1Y1Manipulator );
} );
