...
define( function( require ) {
  ...
  function SettingsNode( model, layoutBounds, levelImages, options ) {
    ...
    levelImages.forEach( function( row ) {
      ...
      row.forEach( function( levelImage ) {
        rowChildren.push( createLevelSelectionItemNodeDeprecated( level, model, levelImage ) );
        level++;
      } );
   ...
   */
  var createLevelSelectionItemNodeDeprecated = function( level, model, levelImage ) {
