...
define( function( require ) {
  ...
  function SlopeInterceptGraphNode( model, viewProperties ) {
      ...
      function( lineProperty, graph, mvt ) {
        return new LineNode( lineProperty, graph, mvt, {
          createEquationNode: function( lineProperty, fontSize ) {
            //TODO this is a temporary adapter until SlopeInterceptEquationNode is mutable
            var parent = new Node();
    ...
    var yInterceptManipulator = new YInterceptManipulator(
      manipulatorRadius, model.interactiveLineProperty, model.y1RangeProperty, model.mvt );
